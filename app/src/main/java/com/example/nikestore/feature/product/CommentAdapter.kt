...
class CommentAdapter(val showAll:Boolean=false):RecyclerView.Adapter<CommentAdapter.ViewHolder>() {
    var comments=ArrayList<com.example.nikestore.data.Comment>()
    set(value) {
        field=value
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val contentTv = itemView.findViewById<TextView>(R.id.commentContent)
        fun bindComment(comment: com.example.nikestore.data.Comment) {
